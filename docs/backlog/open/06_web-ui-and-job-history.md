...
- Dashboard: current job progress (polling), recent jobs, scan-now buttons for dry-run and real mode.
- Job detail page: per-file actions taken, skipped actions with reasons, errors.
